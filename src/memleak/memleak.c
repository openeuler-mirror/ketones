...
static const struct argp_option opts[] = {
	...
	{ "trace", 't', 0, 0, "print trace message for each alloc/free alloc", 0 },
	...
	{ "wa-missing-only", 'F', 0, 0, "workaround to alleviate misjudgments when free is missing", 0 },
	{ "sample-rate", 's', "SAMPLE_RATE", 0, "sample every N-th allocation to decrease to overhead", 0 },
	{ "top", 'T', "TOP_STACKS", 0, "display only this many top allocationg stacks (by size)", 0 },
	...
	{ "symbols-prefix", 'S', "SYMBOL_PREFIX:", 0, "memory allocator symbols prefix", 0 },
	...
	{ "stack-map-max-entries", OPT_STACK_MAP_MAX_ENTRIES, "STACK_MAP_MAX_ENTRIES",
	  0, "The number of unique stack traces that can be stored and displayed (default 10240)", 0 },
