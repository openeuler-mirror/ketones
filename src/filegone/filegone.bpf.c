...
int tracepoint_exit_unlinkat(struct trace_event_raw_sys_exit *ctx)
{
...
int tracepoint_exit_unlink(struct trace_event_raw_sys_exit *ctx)
{
	return trace_exit_unlink(ctx, (int)ctx->ret);
}
...
int tracepoint_exit_rmdir(struct trace_event_raw_sys_exit *ctx)
{
	return trace_exit_unlink(ctx, (int)ctx->ret);
}
...
int tracepoint_exit_rename(struct trace_event_raw_sys_exit *ctx)
{
...
int tracepoint_exit_renameat(struct trace_event_raw_sys_exit *ctx)
{
	return trace_exit_rename(ctx, (int)ctx->ret);
}
...
int tracepoint_exit_renameat2(struct trace_event_raw_sys_exit *ctx)
{
	return trace_exit_rename(ctx, (int)ctx->ret);
}
